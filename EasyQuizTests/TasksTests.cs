...
namespace EasyQuizTests
{
	class TasksTests
	{
		...
		{
			CurrentQuiz.Data.AddTask(new CreatorMultipleResponseTask());
			CurrentQuiz.Data.Tasks[0].AddAnswer();
		...
		{
			CurrentQuiz.Data.AddTask(new CreatorMatchingTask());
			CurrentQuiz.Data.Tasks[0].AddAnswer();
		...
		{
			CurrentQuiz.Data.AddTask(new CreatorSequenceTask());
			CurrentQuiz.Data.Tasks[0].AddAnswer();
